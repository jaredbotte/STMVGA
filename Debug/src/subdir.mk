...
src/%.o: ../src/%.s
	...
	@echo $(PWD)
	arm-none-eabi-as -mcpu=cortex-m0 -mthumb -mfloat-abi=soft -I"/Users/jared/Documents/workspace/VGA/StdPeriph_Driver/inc" -I"/Users/jared/Documents/workspace/VGA/inc" -I"/Users/jared/Documents/workspace/VGA/CMSIS/device" -I"/Users/jared/Documents/workspace/VGA/CMSIS/core" -g -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
