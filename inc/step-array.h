...
/* This code provided by ECE 362 and simply contains the
 * necessary calculations to assign steps to notes.
 */

// The RATE here is slightly slower than the actual rate, but that should be ok.
#define RATE 35156
#define N 100
